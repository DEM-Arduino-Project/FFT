...
// Part modified by klafyvel starts here
...
/* End of the part modifier by klafyvel
   There is a second one towards the end to output the result in the input array.
   It was already being modified by the Approx_FFT function anyway.
*/
